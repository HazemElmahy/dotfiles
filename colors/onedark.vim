...
call s:h("LineNr", { "fg": s:dark_yellow }) "" Line number for ":number" and ":#" commands, and when 'number' or 'relativenumber' option is set.
call s:h("CursorLineNr", {}) " like linenr when 'cursorline' or 'relativenumber' is set for the cursor line.
call s:h("LineNrAbove", {"fg": s:white})
call s:h("LineNrBelow", {"fg": s:gutter_fg_grey})
